...
| hello_world | App zeigt Begrüßung an | FAILED | `Gegeben ist, dass die App frisch gestartet ist, dann wird der Titel "Hallo Welt, Flutter" angezeigt, und der Untertitel "Eine Cross-Plattform-Funktionalität" ist sichtbar, und der Zähler zeigt 0` | `goldens/hello_world.png` |
| hello_world | App startet ohne Fehlerdialog | FAILED | `Gegeben ist, dass die App frisch gestartet ist, dann wird keine Android-Fehlermeldung angezeigt, und die App ist im Vordergrund` | `goldens/hello_world.png` |
| hello_world | Zähler wird durch Tippen erhöht | FAILED | `Gegeben ist, dass der Zähler bei 0 steht, dann zeigt der Zähler 1, dann zeigt der Zähler 2, und der Untertitel "Eine Cross-Plattform-Funktionalität" bleibt sichtbar` | `goldens/hello_world.png` |
| hello_world | Zurücksetzen setzt Zähler auf 0 zurück | FAILED | `Gegeben ist, dass der Zähler bei 2 steht, dann zeigt der Zähler 0` | `goldens/hello_world.png` |
| hello_world | Zurücksetzen ist deaktiviert, wenn Zähler 0 ist | FAILED | `Gegeben ist, dass der Zähler bei 0 steht, dann zeigt der Zähler weiterhin 0` | `goldens/hello_world.png` |
